...
import {View, Text, TextInput, Pressable, StyleSheet, ActivityIndicator, ScrollView, TouchableOpacity} from "react-native";
...
const Login: FunctionComponent<LoginProps> = () => {
    ...
    const submit = async () => {
        ...
        try {
            ...
            // You would typically navigate to home/dashboard here
            // For example: router.replace('/dashboard');
